 ...
 */
 ...
 volatile byte selected_scale;
 volatile signed char knob_bias;
...
volatile PersistentState state = {
  0b1010110101010000, 0, 0, 0, 0, 0, 0, false, qmnearest, 0, {cvoffsetchannel, cvoffsetchannel}, {0,0,0}
};
...
void processCV(byte i, int newadcval) {
  ...
  static byte CVquantized[2] = {0, 0};
    ...
    offsetsemitonesCV[i] = CVquantized[i] - 63 + knob_bias ; // SEBI 
